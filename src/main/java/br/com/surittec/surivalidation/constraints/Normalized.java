...
import br.com.surittec.surivalidation.validator.NormalizedValidator;

@Target({ ElementType.FIELD, ElementType.METHOD, ElementType.PARAMETER })
@Retention(RetentionPolicy.RUNTIME)
@Constraint(validatedBy = NormalizedValidator.class)
@Documented
public @interface Normalized {

	String message() default "{br.com.surittec.surivalidation.constraints.Normalized.message}";
